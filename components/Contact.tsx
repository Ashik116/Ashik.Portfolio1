...
import { EMAIL, PHONE, GITHUB_URL, LINKEDIN_URL } from '../constants';
        ...
        <div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group cursor-pointer">
                <div className="w-12 h-12 glass-card rounded-xl flex items-center justify-center text-[#25D366] group-hover:bg-[#25D366] group-hover:text-white transition-all duration-300 border border-[#25D366]/20">
                ...
                <div>
                  ...
                  <p className="font-medium text-slate-200">Message me</p>
                </div>
              </a>
            </div>
            ...
            <div className="pt-4 border-t border-white/5 mt-4">
              <p className="text-sm text-slate-500 uppercase tracking-widest font-bold mb-4">Social Profiles</p>
              <div className="flex flex-wrap gap-4">
                <a href={GITHUB_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 glass-card px-4 py-3 rounded-xl hover:border-blue-500/50 transition-all group">
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-white/5 text-slate-400 group-hover:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                  </div>
                  <span className="font-medium text-sm">GitHub</span>
                </a>
                
                <a href={LINKEDIN_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 glass-card px-4 py-3 rounded-xl hover:border-blue-500/50 transition-all group">
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-white/5 text-[#0A66C2] group-hover:bg-[#0A66C2] group-hover:text-white transition-all">
