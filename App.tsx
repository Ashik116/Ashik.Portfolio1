  ...
  return (
    <div className="min-h-screen selection:bg-blue-500/30 bg-[#050507]">
      ...
      <footer className="py-12 border-t border-white/5 text-center text-slate-500">
        <p className="text-sm tracking-widest uppercase font-bold">&copy; {new Date().getFullYear()} {NAME}</p>
        <p className="text-xs mt-2 opacity-50">Handcrafted with Flutter Spirits & React Magic</p>
      </footer>
